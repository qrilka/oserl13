...
-define(SMSC_ADDRESS, {200, 74, 220, 131}).
-define(SMPP_PORT, 9011).
-define(SYSTEM_ID, "DATAVISION").
-define(PASSWORD, "waudata").
-define(SOURCE_ADDR, "1040").
...
%% @end
init([]) ->
    case gen_esme:session_start(self(), ?SMSC_ADDRESS, ?SMPP_PORT) of
        {ok, Tx} ->
